...
mixin _$DepartmentModel {
 ...
 String get id; String get departmentCode; String get departmentName; String? get description; String? get parentDepartmentId; String? get companyId; String? get createdAt; String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,departmentCode,departmentName,description,parentDepartmentId,companyId,createdAt,updatedAt);

@override
String toString() {
  return 'DepartmentModel(id: $id, departmentCode: $departmentCode, departmentName: $departmentName, description: $description, parentDepartmentId: $parentDepartmentId, companyId: $companyId, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String departmentCode, String departmentName, String? description, String? parentDepartmentId, String? companyId, String? createdAt, String? updatedAt
});
...
/// Create a copy of DepartmentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? departmentCode = null,Object? departmentName = null,Object? description = freezed,Object? parentDepartmentId = freezed,Object? companyId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
  return _then(DepartmentModel(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String departmentCode,  String departmentName,  String? description,  String? parentDepartmentId,  String? companyId,  String? createdAt,  String? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DepartmentModel() when $default != null:
return $default(_that.id,_that.departmentCode,_that.departmentName,_that.description,_that.parentDepartmentId,_that.companyId,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String departmentCode,  String departmentName,  String? description,  String? parentDepartmentId,  String? companyId,  String? createdAt,  String? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _DepartmentModel():
return $default(_that.id,_that.departmentCode,_that.departmentName,_that.description,_that.parentDepartmentId,_that.companyId,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String departmentCode,  String departmentName,  String? description,  String? parentDepartmentId,  String? companyId,  String? createdAt,  String? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _DepartmentModel() when $default != null:
return $default(_that.id,_that.departmentCode,_that.departmentName,_that.description,_that.parentDepartmentId,_that.companyId,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _DepartmentModel implements DepartmentModel {
  const _DepartmentModel({required this.id, required this.departmentCode, required this.departmentName, this.description, this.parentDepartmentId, this.companyId, this.createdAt, this.updatedAt});
...
@override final  String? parentDepartmentId;
...
/// Create a copy of DepartmentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? departmentCode = null,Object? departmentName = null,Object? description = freezed,Object? parentDepartmentId = freezed,Object? companyId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
